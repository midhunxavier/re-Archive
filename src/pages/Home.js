          ...
          <div className="row">
            <div className="col-md-12">
              <div className="banner-title text-center">
                <h1> Culture and sustainable tourism</h1>
                <p className="opacity-full">
                  Innovative strategies for the re-use and re-activation of the
                  architectural heritage in Northern sparsely populated areas
                </p>
              </div>
            </div>
