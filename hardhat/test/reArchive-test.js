...
describe("DecentralreArchive.sol", () => {
  let contractFactory;
  let contract;
  var mockAddress;
  let admin;
  ...
  beforeEach(async () => {
    ...
    // Deploy DecentralreArchive contract
    contractFactory = await ethers.getContractFactory("DecentralreArchive");
  ...
  describe("Core Functions", () => {
    ...
    it("it should fail by must pay exact listing fee", async () => {
      ...
      await expect(
        ...
        contract,
        "DecentralreArchive__InvalidFee"
      );
    });
    ...
    it("it should fail by insuffisant amount", async () => {
      ...
      await expect(
        ...
        contract,
        "DecentralreArchive__InsufficientAmount"
      );
    });
    ...
    it("it should fail by invalid booking period", async () => {
      ...
      await expect(
        ...
        contract,
        "DecentralreArchive__InvalidBookingPeriod"
      );
    });
    ...
    it("it should fail by already booked for given dates", async () => {
      ...
      await expect(
        ...
        contract,
        "DecentralreArchive__AlreadyBooked"
      );
    });
  });
